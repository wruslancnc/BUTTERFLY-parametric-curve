...
char CurveType[7] = "A20-BUT";
char CurveTypeDesc[80] = "BUTTERFLY ALGO=20 SKIP-STEP2 RUN-STEP1 RUN-ADJFRATE FRATECMD=10";
...
// START BYPASS STEP 1 <<<<<<<<<<<<<<<<<
      ...
      } // CLOSE BARACES FOR STEP 1 / REMOVE IT FOR STEP 2
